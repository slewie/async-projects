...
class AsyncWebScraper:
    ...
    async def run(self) -> List[Dict[str, str]]:
        ...
        It runs the scraper for the all websites in the list.
        """
        tasks = [self.get_and_scrap(url) for url in self.urls]
        return await asyncio.gather(*tasks)

    async def get_and_scrap(self, url: str) -> List[Dict[str, str]]:
        """
        This method is used to scrape the web page. 
        It takes a url as input and returns a list of dictionaries.
        """
    ...
    async def _get_html(self, url: str) -> str:
        ...
        try:
            ...
            logging.error("Request to the %s failed: %s", url, e)
            return ""
